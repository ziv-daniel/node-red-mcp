...
import { errorHandler, requestIdMiddleware, asyncHandler, ValidationError, } from '../utils/error-handling.js';
export class ExpressApp {
    ...
    setupRoutes() {
        ...
        this.app.post('/api/mcp/initialize', asyncHandler(async (req, res) => {
        ...
        this.app.options('/sse', (req, res) => {
            ...
            res.setHeader('Access-Control-Allow-Headers', 'Authorization, Content-Type, Cache-Control, X-Requested-With, X-API-Key');
            res.setHeader('Access-Control-Max-Age', '86400');
            res.status(200).end();
        });
        // Claude website expects /sse endpoint (standard MCP SSE format)
        this.app.get('/sse', authenticateClaudeCompatible, asyncHandler(async (req, res) => {
            try {
                const debugConnections = process.env.DEBUG_CLAUDE_CONNECTIONS === 'true';
                if (debugConnections) {
                ...
                res.writeHead(200, {
                    ...
                    'Access-Control-Allow-Headers': 'Authorization, Content-Type, Cache-Control, X-Requested-With, X-API-Key',
        ...
        this.app.post('/messages', asyncHandler(async (req, res) => {
            try {
        ...
        this.app.post('/api/events', asyncHandler(async (req, res) => {
            try {
                const { method, params, id, jsonrpc } = req.body;
                // Validate JSON-RPC 2.0 format
                if (jsonrpc !== '2.0') {
        ...
        this.app.get('/api/events/secure', authenticate, asyncHandler(async (req, res) => {
            try {
        ...
        this.app.post('/api/events/subscribe', authenticate, asyncHandler(async (req, res) => {
        ...
        this.app.post('/api/events/unsubscribe', authenticate, asyncHandler(async (req, res) => {
            const { connectionId, eventTypes } = req.body;
            if (!connectionId || !Array.isArray(eventTypes)) {
                throw new ValidationError('connectionId and eventTypes array are required');
            }
        ...
        this.app.get('/api/events/stats', authenticate, (req, res) => {
        ...
        this.app.get('/api/events/clients', authenticate, (req, res) => {
        ...
        this.app.delete('/api/events/clients/:connectionId', authenticate, (req, res) => {
        ...
        this.app.get('/api/nodered/flows', authenticate, asyncHandler(async (req, res) => {
        ...
        this.app.get('/api/nodered/nodes', authenticate, asyncHandler(async (req, res) => {
        ...
        this.app.get('/api/nodered/runtime', authenticate, asyncHandler(async (req, res) => {
        ...
        this.app.get('/.well-known/mcp-server', asyncHandler(async (req, res) => {
            const isClaudeMode = process.env.CLAUDE_COMPATIBLE_MODE === 'true';
        ...
        this.app.get('/api/mcp/info', asyncHandler(async (req, res) => {
            const serverInfo = {
                jsonrpc: '2.0',
                result: {
                    protocolVersion: '2024-11-05',
        ...
        this.app.get('/debug/claude-connection', asyncHandler(async (req, res) => {
            const debugInfo = {
                server: {
